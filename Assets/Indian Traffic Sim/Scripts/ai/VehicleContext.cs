...
public class VehicleContext
{
    ...
    // ── Destination ────────────────────────────────────────────────────────
    // Set by VehicleSpawner at spawn. DestinationSystem checks arrival each tick.
    // ChooseTurnPath in VehicleNavigator calls DestinationSystem.ModifyTurnWeights.
    public TrafficNode DestNode { get; set; }
    ...
    // Set by TrafficVehicle.Awake after modules are created
