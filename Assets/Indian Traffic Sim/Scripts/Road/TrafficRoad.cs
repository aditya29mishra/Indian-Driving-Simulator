...
// ─────────────────────────────────────────────────────────────────────────────
// TrafficRoad — road container, node registration, guide points
//
// Represents a road segment between two nodes. Manages lane connections
// and generates guide points for visualization. Registers itself with
// start and end nodes.
//
// Talks to: TrafficNode (start/end nodes), TrafficLane (lanes)
// ─────────────────────────────────────────────────────────────────────────────
...
public class TrafficRoad : MonoBehaviour
{
    ...
    /// <summary>Generates guide points along the road for visualization.</summary>
