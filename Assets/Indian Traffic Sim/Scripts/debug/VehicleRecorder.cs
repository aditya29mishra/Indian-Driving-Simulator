...
// ─────────────────────────────────────────────────────────────────────────────
// VehicleRecorder — per-vehicle telemetry sampling, feeds TrafficDataRecorder
//
// Samples vehicle position, speed, and state at regular intervals.
// Sends frame data to the global TrafficDataRecorder for logging.
//
// Talks to: TrafficVehicle (vehicle data), TrafficDataRecorder (logging)
// ─────────────────────────────────────────────────────────────────────────────
