...
// ─────────────────────────────────────────────────────────────────────────────
// TrafficDebugOverlay — on-screen HUD showing speed, leader, signal state per vehicle
//
// Displays debug information for each vehicle in the scene.
// Shows speed, driver profile, leader, signal state, and lane change status.
//
// Talks to: TrafficVehicle (vehicle data)
// ─────────────────────────────────────────────────────────────────────────────
