...
// ─────────────────────────────────────────────────────────────────────────────
// TrafficInspector — click-to-inspect panel, shows last 10 log entries for selected vehicle
//
// Displays detailed information about a selected vehicle including position,
// speed, lane, leader, signal state, and recent log entries from TrafficEventLogger.
//
// Talks to: TrafficVehicle (vehicle data), TrafficEventLogger (log entries)
// ─────────────────────────────────────────────────────────────────────────────
