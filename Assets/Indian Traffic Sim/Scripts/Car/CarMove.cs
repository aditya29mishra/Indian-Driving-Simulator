...
// ─────────────────────────────────────────────────────────────────────────────
// CarMove — physics driving layer for vehicles
//
// Handles wheel torque, braking, downforce, traction control, gear simulation.
// Receives throttle/brake/steer inputs from TrafficVehicle.Move() and applies
// forces to Rigidbody and WheelColliders. No AI logic here.
//
// Talks to: CarWheels (wheel collider and mesh sync)
// ─────────────────────────────────────────────────────────────────────────────
...
public class CarMove : MonoBehaviour
{
    ...
    /// <summary>Gets whether the car is skidding.</summary>
    public bool Skidding { get; private set; }
    /// <summary>Gets the current brake input value.</summary>
    public float BrakeInput { get; private set; }
    /// <summary>Gets the current steering angle in degrees.</summary>
    public float CurrentSteerAngle { get { return m_SteerAngle; } }
    /// <summary>Gets the current speed in MPH.</summary>
    public float CurrentSpeed { get { return m_Rigidbody.velocity.magnitude * 2.23693629f; } }
    /// <summary>Gets the maximum speed.</summary>
    public float MaxSpeed { get { return m_Topspeed; } }
    /// <summary>Gets the current engine revs (normalized 0-1).</summary>
    public float Revs { get; private set; }
    /// <summary>Gets the current acceleration input value.</summary>
    ...
    /// <summary>Applies driving inputs to the car.</summary>
    /// <param name="accel">Acceleration input (0-1).</param>
    /// <param name="footbrake">Footbrake input (0 to -1, negative for braking).</param>
